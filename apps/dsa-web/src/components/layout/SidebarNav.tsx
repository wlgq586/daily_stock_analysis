...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'stocks', labelKey: 'layout.nav.stocks', to: '/stocks', icon: TrendingUp },
  ...
  return (
    <div className="flex h-full flex-col">
      ...
      >
        ...
        {!collapsed ? (
          <p className={cn('min-w-0 truncate font-semibold text-foreground', isRail ? 'text-[0.95rem] leading-none' : 'text-sm')}>YQ</p>
        ) : null}
      </div>
